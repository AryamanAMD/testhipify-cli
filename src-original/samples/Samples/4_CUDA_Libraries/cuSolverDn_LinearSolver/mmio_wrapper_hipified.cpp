...
template <> __inline__ hipComplex cuGet<hipComplex>(int x)
{
    return (make_hipComplex( float(x), 0.0f ));
}

template <> __inline__ hipDoubleComplex  cuGet<hipDoubleComplex>(int x)
{
    return (make_hipDoubleComplex( double(x), 0.0 ));
}
...
template <> __inline__ hipComplex cuGet<hipComplex>(int x, int y)
{
    return make_hipComplex( float(x), float(y) );
}

template <> __inline__ hipDoubleComplex  cuGet<hipDoubleComplex>(int x, int y)
{
    return (make_hipDoubleComplex( double(x), double(y) ));
}
...
template <> __inline__ hipComplex cuGet<hipComplex>(float x)
{
    return (make_hipComplex( float(x), 0.0f ));
}

template <> __inline__ hipDoubleComplex  cuGet<hipDoubleComplex>(float x)
{
    return (make_hipDoubleComplex( double(x), 0.0 ));
}
...
template <> __inline__  hipComplex cuGet<hipComplex>(float x, float y)
{
    return (make_hipComplex( float(x), float(y) ));
}

template <> __inline__  hipDoubleComplex  cuGet<hipDoubleComplex>(float x, float y)
{
    return (make_hipDoubleComplex( double(x), double(y) ));
}
...
template <> __inline__ hipComplex cuGet<hipComplex>(double x)
{
    return (make_hipComplex( float(x), 0.0f ));
}

template <> __inline__ hipDoubleComplex  cuGet<hipDoubleComplex>(double x)
{
    return (make_hipDoubleComplex( double(x), 0.0 ));
}
...
template <> __inline__  hipComplex cuGet<hipComplex>(double x, double y)
{
    return (make_hipComplex( float(x), float(y) ));
}

template <> __inline__  hipDoubleComplex  cuGet<hipDoubleComplex>(double x, double y)
{
    return (make_hipDoubleComplex( double(x), double(y) ));
}
...
template int loadMMSparseMatrix<hipComplex>(
    char *filename, 
    char elem_type, 
    bool csrFormat, 
    int *m, 
...
template int loadMMSparseMatrix<hipDoubleComplex>(
    char *filename, 
    char elem_type, 
    bool csrFormat, 
    int *m, 
